                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="p-2">
                                ...
                                <div>
                                    <a href="<?php echo BASE_URL; ?>" class="logo logo-admin"><img src="<?php echo BASE_URL; ?>public/img/logo.png" height="100" alt="logo"></a>
                                </div>
                            </div>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal m-t-20" id="formulario" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <input class="form-control" id="email" name="email" type="email" required="" value="ana.info1999@gmail.com" placeholder="Email">
                                        </div>
                                    </div>
