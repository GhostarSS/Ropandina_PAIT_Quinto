...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="<?php echo BASE_URL; ?>public/img/logo.png" alt="" width="100"></a>
        </div>
                    ...
                    <?php if ($data['title'] == 'Pagina Principal') { ?>
                        <div class="hero__item set-bg" data-setbg="<?php echo BASE_URL; ?>public/img/hero/banner.jpg">
                            <div class="hero__text">
                                ...
                                <h2>Viste con Estilo  <br />y Conciencias</h2>
                                <br>
                                <p style="color: black; box-shadow: 3px 3px 10px rgba(0, 0, 0, 0.5);">Descubre nuestra última colección de prendas fabricadas con materiales 100% sostenibles. 
                                <br>¡Haz tu declaración de moda con nosotros y contribuye a la conservación del planeta!</p>
                                <a href="<?php echo BASE_URL . 'principal/productos'; ?>" class="primary-btn">Ver Ropa</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
